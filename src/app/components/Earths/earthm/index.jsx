...
<script type="module">
  ...
  let mearth = document.querySelector("#mearth");
  ...
  mearth.appendChild(renderer.domElement);
  ...
  (async function () {
    ...
    let envmapTexture = await new RGBELoader()
      ...
      .loadAsync("assets/hdr.hdr"); // thanks to https://polyhaven.com/hdris !
    ...
    let textures = {
      ...
      planeTrailMask: await new TextureLoader().loadAsync(
        "assets/mask.png"
      ),
    };
    ...
    let plane = (await new GLTFLoader().loadAsync("assets/scene.glb")).scene
      .children[0];
    let planesData = [
          ...
          ringsScene.children.forEach((child, i) => {
            child.traverse((object) => {
              object.material.opacity =
                object.sunOpacity * (1 - obj.t) +
                object.moonOpacity * obj.t;
            });
          });
    ...
    renderer.setAnimationLoop(() => {
      ...
      ring2.rotation.x =
        ring2.rotation.x * 0.95 + mousePos.y * 0.05 * 0.375;
      ring2.rotation.y =
        ring2.rotation.y * 0.95 + mousePos.x * 0.05 * 0.375;

      ring3.rotation.x =
        ring3.rotation.x * 0.95 - mousePos.y * 0.05 * 0.275;
      ring3.rotation.y =
        ring3.rotation.y * 0.95 - mousePos.x * 0.05 * 0.275;
